...
uint8_t tmc2130_sg_thr_home[4] = {TMC2130_SG_THRS_X_HOME, TMC2130_SG_THRS_Y_HOME, TMC2130_SG_THRS_Z_HOME, TMC2130_SG_THRS_E_HOME};
...
//use chopper settings from variant file
